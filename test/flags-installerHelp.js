...
var outfile = path.resolve(__dirname, 'output/flags-installer-help.out');

var output = fs.readFileSync(__dirname + '/expected/installer-help.txt', 'utf8').replace(/(\r\n|\n|\r)\s?/gm,'\n');

lab.experiment('installer: flag: help', () => {
    ...
    lab.test('shows help using --help', (done) => {
        child.exec('node ' + __dirname + '/../bin/genHook.js installer --help > ' + outfile, (err) => {
